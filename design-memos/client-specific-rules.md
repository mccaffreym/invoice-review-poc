...
**Context:** Extension memo for the [Invoice Review Assistant POC](../README.md). The reviewer's `client_id` parameter exists as the architectural hook for this design.
